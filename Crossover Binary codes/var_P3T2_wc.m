function y = var_P3T2_wc(ps,mu,alpha,tau,gam,R)
p = 3;
...
X1 = [ones(p,1) [0,0;1,0;0,1] tau1 gam1];
X2 = [ones(p,1) [0,0;1,0;0,1] tau2 gam2];
X3 = [ones(p,1) [0,0;1,0;0,1] tau3 gam3];
X4 = [ones(p,1) [0,0;1,0;0,1] tau4 gam4];
X5 = [ones(p,1) [0,0;1,0;0,1] tau5 gam5];
X6 = [ones(p,1) [0,0;1,0;0,1] tau6 gam6];
X7 = [ones(p,1) [0,0;1,0;0,1] tau7 gam7];
X8 = [ones(p,1) [0,0;1,0;0,1] tau8 gam8];
